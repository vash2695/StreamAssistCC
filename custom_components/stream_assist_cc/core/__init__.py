        ...
        if event.type == PipelineEventType.STT_START:
            ...
            if player_entity_id:
                ...
                async def simulate_wake_word_and_continue():
                    ...
                    # Trigger a new assist_run, starting from STT stage
                    new_assist = data.copy()
                    new_assist['assist'] = new_assist.get('assist', {})
                    new_assist['assist']['start_stage'] = PipelineStage.STT
                    
                    hass.create_task(assist_run(
                        hass,
                        new_assist,
                        context=context,
